...
import { FeatureName, featureNames, isFeatureNameDisabled, ModelSelection, modelSelectionsEqual, ProviderName, providerNames, SettingsOfProvider } from '../../../../common/codeshetraSettingsTypes.js'
...
const ModelSelectBox = ({ options, featureName, className }: { options: ModelOption[], featureName: FeatureName, className: string }) => {
	...
	const selectedOption = selection ? voidSettingsService.state._modelOptions.find((v: ModelOption) => modelSelectionsEqual(v.selection, selection))! : options[0]
